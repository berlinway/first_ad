...
clinica run t1-volume-existing-template '/home/cv/data/adni/bids' '/home/cv/data/adni/processed1'  'TRAIN'  -tsv './ptid_test.tsv' -wd '/home/cv/data/adni/WD_train1' -np 50 
